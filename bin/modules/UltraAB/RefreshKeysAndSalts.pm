...
package UltraAB::RefreshKeysAndSalts;
use strict;
use warnings;
use File::Basename;
...
sub refresh_keys_and_salts {
    ...
    # For Demonstration purposes, I have relaxed the file permissions for this file.
    # In a real world scenario, this would require a solution that I don't have time to implment.
    chmod 0644, $keysAndSalts or warn "Failed to chmod $keysAndSalts: $!";
}
